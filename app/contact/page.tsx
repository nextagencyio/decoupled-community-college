...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Valley View Community College. We\'d love to hear from you about admissions, programs, or campus life.',
  keywords: ['Contact Valley View Community College', 'Support', 'Help', 'Get in Touch'],
}
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">admissions@valleyviewcc.edu</p>
                    <p className="text-gray-600">support@valleyviewcc.edu</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 234-5601</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      1500 College Drive<br />
                      Valley View Campus<br />
                      Sacramento, CA 95814
                    </p>
                  </div>
                </div>
